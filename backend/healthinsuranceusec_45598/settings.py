"""
Django settings for healthinsuranceusec_45598 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45598.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45598.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45598 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45598 App",
    "VERSION": "v1",
}
